...
public class HuntBehaviour implements Behaviour {
	 ...
	 * @param range		The maximum range of hunting
	 * @throws NullPointerException if cls or range argument is null
	 */
	public HuntBehaviour(Class<?> cls, int range) throws NullPointerException{
	...
	/**
	 * 
	 * @param actor		The actor that hunts target
	 * @param map		The map where the actor is at
